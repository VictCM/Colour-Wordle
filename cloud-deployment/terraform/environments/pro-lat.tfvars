...
public_subnets         = ["192.168.141.64/27", "192.168.142.64/27", "192.168.143.64/27", "192.168.151.64/27", "192.168.152.64/27", "192.168.153.64/27" ]
...
forti_instances = { ### some cases if values are "" or null then it get forti_instances_default_conf values
  faz-01 = {
    ...
    sg_rules                   = null
    serial_number              = "22005582"
  }
  fmg-01 = {
    instance_type              = "fortimanager"
    secure_instance_id         = null
    network_private_ip_hostnum = 5
    permanent_eip              = true
    compute_instance_type      = null
    compute_ami                = null
    base_storage_conf          = null
    extra_storage_conf         = null
    sg_rules                   = null
    serial_number              = "22005498"
  }
  portal-01 = {
    instance_type              = "fortiportal"
    secure_instance_id         = null
    network_private_ip_hostnum = 6
    permanent_eip              = false
    compute_instance_type      = null
    compute_ami                = null
    base_storage_conf          = null
...
fortiportal_db_conf = {
  instance_conf = {
    ...
    storage_conf = ["20", "500", true, "gp2", ""]                           ### [ init_storage_GB, max_storage_scale_GB (if 0 not scale), encrypted, storage_type, iops (only io1 storage_type)]
